...
//
//     final allMaletest1 = allMaletest1FromJson(jsonString);

import 'dart:convert';

// AllMaletest1 allMaletest1FromJson(String str) => AllMaletest1.fromJson(json.decode(str), ThreeSigninScreen.userUidAccess);

// String allMaletest1ToJson(AllMaletest1 data) => json.encode(data.toJson(ThreeSigninScreen.userUidAccess), );

class AllMaletest1 {
    List<CurUser>? curUsers;

    AllMaletest1({
        this.curUsers,
    });

    factory AllMaletest1.fromJson(Map<String, dynamic> json, String uidf) => AllMaletest1(
        curUsers: json[uidf] == null ? [] : List<CurUser>.from(json[uidf]!.map((x) => CurUser.fromJson(x))),
    );

    Map<String, dynamic> toJson( String uidf) => {
        uidf: curUsers == null ? [] : List<dynamic>.from(curUsers!.map((x) => x.toJson())),
    };
}
...
class CurUser {
    ...
    CurUser({
        ...
        this.primaryCountry,
        this.selfie = "https://www.asiaoceania.org/aogs2021/img/no_uploaded.png",
        this.fullSizeImage,
        this.familyImage,
        this.gallery,
        this.horoscope,
